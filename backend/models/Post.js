...
const postSchema = mongoose.Schema(
  {
    ...
    policyViolationLocked: { type: Boolean, default: false },
    policyViolationLabel: { type: String, default: '' },
    policyViolationLockedAt: { type: Date, default: null },
    policyViolationLockedBy: { type: mongoose.Schema.Types.ObjectId, ref: 'AdminData', default: null },
