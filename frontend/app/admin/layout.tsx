    ...
    <div className="flex min-h-screen bg-[#f8f9fa] text-slate-800 font-sans">
      ...
      <aside className="w-64 bg-[#f8f9fa] flex flex-col pt-6 pb-6 px-4 h-screen sticky top-0 border-r border-slate-200">
        ...
        <nav className="flex-1 space-y-1">
          ...
          <Link href="/admin/moderation" className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-slate-500 hover:text-slate-800 hover:bg-slate-100 transition-colors">
            <FileText className="w-4 h-4" /> Content Moderation
          </Link>
          <Link href="/admin/users" className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-slate-500 hover:text-slate-800 hover:bg-slate-100 transition-colors">
            <UserPlus className="w-4 h-4" /> User Management
          </Link>
          <Link href="/admin/support" className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-slate-500 hover:text-slate-800 hover:bg-slate-100 transition-colors">
