  ...
  return (
    <div className="flex flex-col items-center bg-[#f9f9f9] min-h-screen font-sans pb-20 relative">
       ...
       <div className="w-full max-w-5xl px-8 flex flex-col items-center justify-center pt-16 pb-12 relative">
          <h1 className="text-[42px] font-bold text-[#1c1917] tracking-tighter mb-8 shadow-sm">Creator Name</h1>
       ...
       <div className="w-full max-w-4xl px-8 flex flex-col items-stretch space-y-6">
          ...
          {activeTab === 'Home' && (
            <>
              ...
              <div className="flex justify-between items-center mb-2">
                 <h2 className="text-[28px] font-bold tracking-tight text-[#1c1917]">Home</h2>
                 <div className="flex items-center gap-3">
                   <button className="px-5 py-2 bg-white border border-slate-200 text-slate-700 text-sm font-bold rounded-full hover:bg-slate-50 transition-colors flex items-center gap-2 shadow-sm">
              ...
              <div className="bg-white border border-slate-200/60 rounded-2xl p-8 shadow-sm">
                 <h3 className="text-xl font-bold text-[#1c1917] mb-2">Welcome to Creatorhub</h3>
                 ...
                 <p className="text-[13px] font-bold text-rose-500 mb-8">0 of 5 complete</p>
                 ...
                 <div className="space-y-0 relative">
                    ...
                    <div onClick={() => setBasicsOpen(true)} className="flex gap-5 items-start relative group cursor-pointer py-4 border-b border-slate-100/80">
                       ...
                       <div className="pt-1 flex-1">
                         <h4 className="text-[15px] font-bold text-[#1c1917] mb-1">Start with basics</h4>
                    ...
                    <div className="flex gap-5 items-start relative group cursor-pointer py-4 border-b border-slate-100/80">
                       ...
                       <div className="pt-1 flex-1">
                         <h4 className="text-[15px] font-bold text-[#1c1917] mb-1">Make your first post</h4>
                         ...
                         <a href="#" className="text-[13px] font-medium text-rose-500 hover:text-rose-600 underline">Tips for your first post</a>
                       </div>
                       <div className="pt-2">
                         <ArrowRight className="w-5 h-5 text-slate-300 group-hover:text-rose-500 transition-colors" />
                       </div>
                    ...
                    <div className="flex gap-5 items-start relative group cursor-pointer py-4 border-b border-slate-100/80">
                       ...
                       <div className="pt-1 flex-1">
                         <h4 className="text-[15px] font-bold text-[#1c1917] mb-1">Choose your layout</h4>
                    ...
                    <div className="flex gap-5 items-start relative group cursor-pointer py-4 border-b border-slate-100/80">
                       ...
                       <div className="pt-1 flex-1">
                         <h4 className="text-[15px] font-bold text-[#1c1917] mb-1">Publish your page</h4>
                    ...
                    <div className="flex gap-5 items-start relative group cursor-pointer py-4">
                       ...
                       <div className="pt-1 flex-1">
                         <h4 className="text-[15px] font-bold text-[#1c1917] mb-1">Promote your Createrhub</h4>
              ...
              {/* Earn Money Card */}
              <div className="bg-white border border-slate-200/60 rounded-2xl p-8 shadow-sm">
                 <h3 className="text-[17px] font-bold text-[#1c1917] mb-3">Ways to earn money</h3>
                 <p className="text-[14px] font-medium text-slate-600 leading-relaxed max-w-3xl">
                   Creatorhub is a free space for you and your fans to connect directly. If you want to grow your business, it's easy to offer exclusive content, membership tiers, or digital products.
                 </p>
          ...
          {activeTab === 'Collections' && (
             <div className="space-y-6">
                <div className="flex justify-between items-center mb-2">
                   <h2 className="text-[28px] font-bold tracking-tight text-[#1c1917]">Collections</h2>
                ...
                <div className="bg-white border border-slate-200/60 rounded-2xl p-12 shadow-sm flex flex-col items-center text-center">
                   ...
                   <h3 className="text-xl font-bold text-[#1c1917] mb-2">No collections yet</h3>
          ...
          {activeTab === 'Shop' && (
             <div className="space-y-6">
                <div className="flex justify-between items-center mb-2">
                   <h2 className="text-[28px] font-bold tracking-tight text-[#1c1917]">Shop</h2>
                   <button className="px-5 py-2 bg-rose-500 text-white text-sm font-bold rounded-full hover:bg-rose-600 transition-colors flex items-center gap-2 shadow-sm">
                ...
                <div className="bg-white border border-slate-200/60 rounded-2xl p-12 shadow-sm flex flex-col items-center text-center">
                   ...
                   <h3 className="text-xl font-bold text-[#1c1917] mb-2">Your shop is empty</h3>
                   <p className="text-sm font-medium text-slate-500 mb-8 max-w-sm">
          ...
          {activeTab === 'Membership' && (
            <div className="bg-[#ede9df] rounded-3xl overflow-hidden shadow-sm flex flex-col md:flex-row min-h-[500px]">
               <div className="p-12 md:w-1/2 flex flex-col justify-center gap-8 border-r border-[#d6d3d1]/30">
                 <h2 className="text-[36px] font-bold text-[#1c1917] leading-tight">Build your paid membership</h2>
                 ...
                 <div className="space-y-8">
                    <div className="flex gap-4">
                      ...
                      <div>
                        <h4 className="text-base font-bold text-[#1c1917] mb-1">Income you can count on</h4>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        <h4 className="text-base font-bold text-[#1c1917] mb-1">Start with what you have</h4>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        <h4 className="text-base font-bold text-[#1c1917] mb-1">Grow your creative business</h4>
               ...
               <div className="bg-[#f5f5f4] md:w-1/2 flex items-center justify-center p-12 overflow-hidden relative">
                  <div className="bg-[#1c1917] w-full max-w-[300px] rounded-3xl shadow-2xl overflow-hidden transform hover:scale-[1.05] transition-transform duration-500">
                     ...
                     <div className="p-8">
                        <h4 className="text-white text-base font-bold mb-1">Friend of the Show</h4>
                        <p className="text-white text-2xl font-bold mb-6">$5 <span className="text-sm font-medium text-slate-400">/ month</span></p>
          ...
          {activeTab === 'Recommendations' && (
             <div className="space-y-6 w-full">
               <div className="bg-[#ede9df] rounded-3xl p-12 flex flex-col items-start shadow-sm border border-[#d6d3d1]/30">
                 <h2 className="text-[28px] font-bold text-[#1c1917] mb-4">Recommendations for your fans</h2>
               ...
               <div className="bg-white border border-slate-200/60 rounded-3xl p-12 shadow-sm">
                 <h2 className="text-[22px] font-bold text-[#1c1917] mb-4">Creators recommending you to their fans</h2>
       ...
       {basicsOpen && (
         <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 backdrop-blur-[2px]">
            <div className="bg-white rounded-[32px] shadow-2xl w-[440px] p-8 pt-6 relative flex flex-col">
               
               <div className="flex justify-center w-full relative mb-8">
                 <h3 className="text-base font-bold text-[#1c1917]">Start with the basics</h3>
                 <button 
               ...
               <div className="flex justify-center mb-8 relative">
                 <div className="w-24 h-24 rounded-full bg-rose-200 text-white text-5xl font-black flex items-center justify-center shadow-inner relative z-10 border-4 border-white overflow-hidden">
                   R
                 </div>
               ...
               <div className="space-y-6 mb-8">
                 <div>
                   <label className="block text-xs font-bold text-slate-700 mb-2.5 ml-1">Page Name</label>
                   <input type="text" placeholder="Rocco" className="w-full bg-[#fcfcfc] border border-slate-200 rounded-xl px-4 py-4 text-sm focus:outline-none focus:ring-1 focus:ring-rose-200 focus:border-rose-300 transition-colors shadow-sm" />
                 </div>
                 <div>
                   <label className="block text-xs font-bold text-slate-700 mb-2.5 ml-1">Your Creator URL</label>
                   <div className="relative">
                     <span className="absolute left-4 top-4 text-sm text-slate-400 font-medium select-none">creatorhub.com/</span>
                     <input type="text" placeholder="rocco914" className="w-full bg-[#fcfcfc] border border-slate-200 rounded-xl pl-[124px] pr-4 py-4 text-sm font-bold text-slate-800 focus:outline-none focus:ring-1 focus:ring-rose-200 focus:border-rose-300 transition-colors shadow-sm" />
                   </div>
                 </div>
                 <div>
                   <label className="block text-xs font-bold text-slate-700 mb-2.5 ml-1">What do you create ?</label>
                   <input type="text" placeholder="E.g. A podcast for pizza makers" className="w-full bg-[#fcfcfc] border border-slate-200 rounded-xl px-4 py-4 text-sm focus:outline-none focus:ring-1 focus:ring-rose-200 focus:border-rose-300 transition-colors shadow-sm mb-2" />
                   <p className="text-[11px] font-medium text-slate-500 px-1">Be specific so people can discover your work.</p>
                 </div>
               </div>

               <div className="flex gap-4">
                  <button onClick={() => setBasicsOpen(false)} className="flex-1 py-4 bg-slate-50 hover:bg-slate-100 text-slate-700 text-sm font-bold rounded-2xl transition-colors border border-slate-200">
                    Cancel
                  </button>
                  <button className="flex-1 py-4 bg-[#d94828] hover:bg-[#c93d1f] text-white text-sm font-bold rounded-2xl shadow-xl transition-colors border-b-4 border-[#b9381b]">
                    Save
                  </button>
               </div>
            </div>
       ...
       {recommendOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 backdrop-blur-[2px]">
             <div className="bg-white rounded-[32px] shadow-2xl w-[480px] p-8 relative flex flex-col">
                ...
                <h2 className="text-xl font-bold text-[#1c1917] mb-2 pr-8 leading-tight">Add a recommendation</h2>
